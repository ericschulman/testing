...
def bootstrap_distr(ll1,grad1,hess1,params1,ll2,grad2,hess2,params2,c1=.01,c2=.02,trials=500,alpha=.05,print_stuff=False,data_tuned_c=False):
    ...
    if data_tuned_c is not None:
        ...
        #accidentally suqaring... this stuff seems like a really good way to check if omega is growign tho...
        c1_mod = c1*distr_term

    c2 = c2_orig#*nobs
    bonus_term  = c2*c1_mod/(omega+c1_mod) 
    ...
    if print_stuff:
        ...
        print('bonus term',bonus_term,'// variance stats',omega, '//part1', c2, '//part2', c1_mod/(omega+c1_mod)  )
