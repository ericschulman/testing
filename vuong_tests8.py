...
##############################
def bootstrap_distr(ll1,grad1,hess1,params1,ll2,grad2,hess2,params2,c1=.01,c2=.02,trials=500,alpha=.05,print_stuff=False):
    ...
    if print_stuff:
        ...
        #print other stuff
        #print('bonus term',np.sqrt(nobs)*c2/(omega+c1_mod),np.sqrt(nobs)*c2/(omega),'// variance stats',np.sqrt(nobs)*omega,np.sqrt(nobs)*(omega+c1_mod))
...
def monte_carlo(total,gen_data,setup_shi,skip_boot=False,skip_shi=False,refinement_test=False,trials=500,biascorrect=False,c1=None,c2=None,alpha=.05,adapt_c=True,print_stuff=True):
    ...
    for i in range(total):
        ...
        if not skip_boot:
            ...
            test_stats1,test_stats2,test_stats3a,test_stats3b ,test_stat1,test_stat2,test_stat3 = bootstrap_distr(ll1,grad1,hess1,params1,ll2,grad2,hess2,params2,c1=c1,c2=c2,trials=trials,print_stuff=print_stuff_i)
            #print('-- test1 --')
